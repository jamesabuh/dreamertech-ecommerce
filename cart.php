                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <!--   <button class="bg-info
                                 px-3 py-2 border-0 mx-3">Remove</button>-->
       ...
       ?>
                ...
                if($result_count>0){
                    ...
                    class='bg-info px-3 py-2 border-0 mx-3'
                     name='countinue_shopping'>
                    
                    <button class='bg-secondary p-3 py-2 border-0'><a href='./users_area/checkout.php' class='text-light
